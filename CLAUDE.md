...
This project is indexed by GitNexus as **HipCortex** (6366 symbols, 12718 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
