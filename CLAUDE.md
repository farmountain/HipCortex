...
This project is indexed by GitNexus as **HipCortex** (6463 symbols, 12881 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
