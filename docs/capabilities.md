...
Honest surface coverage as of **product v0.5.0 / VSIX v0.5.7** (code-grounded, not aspirational).
...
MCP serverInfo version in `sdk/mcp/server.py`: **0.5.0**. VS Code extension package: **0.5.7** (10 LM tools).
