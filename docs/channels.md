...
|---------|--------|---------|-------|
| Rust binary / Cargo | native | `cargo build` / GitHub Releases | Crate **0.5.2** (Win/macOS/Linux amd64+arm64) |
| pip (Python SDK + CLI) | native | `pip install hipcortex` | Wizard + SDK **0.5.2** (platform-agnostic) |
