...
[hipcortex-memory-0.5.6.vsix](https://github.com/farmountain/HipCortex/releases/download/v0.5.0/hipcortex-memory-0.5.6.vsix)

```bash
code --install-extension hipcortex-memory-0.5.6.vsix
```
...
**License:** [Apache-2.0](LICENSE) · **Version:** product `0.5.0` · extension VSIX `0.5.6`
