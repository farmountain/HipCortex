...
This project is indexed by GitNexus as **HipCortex** (7023 symbols, 13782 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
