...
This project is indexed by GitNexus as **HipCortex** (6888 symbols, 13530 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
