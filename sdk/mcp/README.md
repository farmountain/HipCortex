# HipCortex Universal MCP Server & Multi-Agent Setup Guide (`v0.5.2`)
...
`serverInfo.version` = **0.5.2** (product / VERSION). Full capability matrix: [docs/capabilities.md](../../docs/capabilities.md).
