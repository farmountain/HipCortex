# HipCortex TypeScript & Node.js SDK (`v3.11.0`)
...
>
> **Version matrix:** npm client **3.11.0** talks to server **3.11.0** (includes `/worldmodel/rollout`, live_beliefs, predict). VS Code extension is **3.11.0** with 10 LM tools — [docs/channels.md](../../docs/channels.md).
