# HipCortex TypeScript & Node.js SDK (`v3.12.0`)
...
>
> **Version matrix:** npm client **3.12.0** talks to server **3.12.0** (includes `/worldmodel/rollout`, live_beliefs, predict). VS Code extension is **3.12.0** with 10 LM tools — [docs/channels.md](../../docs/channels.md).
